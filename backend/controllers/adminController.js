...
const getInfo = asyncHandler(async(req,res)=>{
  ...
  const studentLendth = student.length;
  const teacherLendth = teacher.length;
  const classroomLendth = classroom.length;
  res.status(200).json({studentLendth,teacherLendth,classroomLendth})
})
